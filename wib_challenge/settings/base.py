...
# ACCOUNT_SIGNUP_REDIRECT_URL = "/"  # Force la redirection après inscription
# SOCIALACCOUNT_AUTO_SIGNUP = True  # Active l'inscription automatique
...
JAZZMIN_SETTINGS = {
    ...
    "show_ui_builder": os.getenv('DEBUG', 'False').lower() == 'false',
    ...
    "order_with_respect_to": [
        ...
        "accounts.user",
        "education.school",
        "education.schoolstaff",
        "education.academicclass",
        "education.student",
        "education.subject",
        "education.exam",
        "education.teacherquestion",
        "questions.question",
